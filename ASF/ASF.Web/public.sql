...
-- ----------------------------
-- Sequence structure for asf_help_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."asf_help_id_seq";
CREATE SEQUENCE "public"."asf_help_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
CACHE 1;
ALTER SEQUENCE "public"."asf_help_id_seq" OWNER TO "kong";
...
-- ----------------------------
-- Sequence structure for asf_message_inbox_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."asf_message_inbox_id_seq";
CREATE SEQUENCE "public"."asf_message_inbox_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
CACHE 1;
ALTER SEQUENCE "public"."asf_message_inbox_id_seq" OWNER TO "kong";
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."asf_account_role" ("id", "account_id", "role_id", "create_time") VALUES (1, 1, 3, '2022-11-19 12:47:27.013087');
COMMIT;
...
INSERT INTO "public"."asf_accounts" ("id", "tenancy_id", "department_id", "name", "username", "password", "password_salt", "telphone", "email", "avatar", "status", "is_deleted", "sex", "create_id", "create_time", "login_ip", "login_time", "login_location", "token", "refresh_token", "expired") VALUES (1, 1, 2, 'keep_wan', 'admin', '20V6MgmX8XVtiRz10AI4Ib5H16a9JyrNmSwmgJ2k0iI=', '8283e4c3-f87e-4d85-85fb-f5c0de063992', '86+13800000000', 'admin@qq.com', 'https://minioapi.zytravel.shop/avatar/333128767074963456avatarGroup1052.png', 1, 0, 1, 0, '2021-11-15 07:21:24.550098', '127.0.0.1', '2026-03-31 03:27:50.236537+00', '本地', 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..tRf0HynpDeaJ1-8JS7YBOBPFz1ml-ExIU4Ix050g07nOBUQQOMB17By8QpDKU-4sc_s4oZoY-9PduSicD21zsQ7FpERA06OdMN_Oyqj4n_PMUNcpp5pEjBfVw38NevWwdbZ6x2D6Cod-VKYfroTM6LyxtuIKrFkMbUK4ilSVEbUxp8nanG-oIeE1-wfSrd2fxdp4Gkr64Zadq1Pt0kzNYyOvdilGWjb2XR7MB2iwZ0jdHTxFM2Knv44LQ8xaNYvcKIaohCA53Y7bERlm-ZpiHiC9rkjbhVL1Tuz1jTUZFriIWU7XUWEZDhIPCDKcU3955sUSGNhSAj6sJsPBW-Z6Ag', 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..vreEyqWVNRNpJjfz2W8o8m3gmiZea3u0xK6RroZiJbJ2KGTSzOvUnQH5ex0PA3T4P-0wBMBYbvzCEeqlQHZkdWxD3w3p4-AEJcTGgaq4L5phxwXTwQZr6YX4hqkOvbHYDzM1BJJQUuhg7Sga3SDNH4mS66xwBkHEd1KTH6AvjXNWjeWCKcn9T5G2ZeKIRxjANNmCpgjZLNOGxbXp0SpAncLxuzyAHY-0nPypnoLYB_S5WbRwf3IHaRReOx8kdv--_wvw9RsulYiORUdUzHNnBUz8yNyV4dWW58xsHd2malVq2xEe_GCEWE1xxpi8qejoxCYNxswmhbWPP94wAalwmw', '2026-04-01 03:27:50.221869+00');
COMMIT;
...
CACHE 1
  ...
  "country_code" varchar(250) COLLATE "pg_catalog"."default" NOT NULL,
  "category_key " varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "title_key" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "content_key" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "status" int4 DEFAULT 1,
  "create_time" timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
;
ALTER TABLE "public"."asf_help" OWNER TO "kong";
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."asf_loginfos" ("id", "account_id", "account_name", "type", "subject", "client_ip", "client_location", "permission_id", "add_time", "api_address", "api_request", "api_response", "remark") VALUES (793727265075056640, 1, 'admin', 3, '异常消息', '127.0.0.1', '本地', NULL, '2026-03-31 07:47:43.651802', '/api/asf/account/create', '', 'An error occurred while saving the entity changes. See the inner exception for details.', '操作记录');
INSERT INTO "public"."asf_loginfos" ("id", "account_id", "account_name", "type", "subject", "client_ip", "client_location", "permission_id", "add_time", "api_address", "api_request", "api_response", "remark") VALUES (793727265112805376, 1, 'admin', 2, '添加账户', '127.0.0.1', '本地', 3, '2026-03-31 07:47:43.660732', '/api/asf/account/create', '{"data":""}', '{"status":500,"result":null,"message":"An error occurred while saving the entity changes. See the inner exception for details."}', '操作记录');
COMMIT;

-- ----------------------------
-- Table structure for asf_message_inbox
-- ----------------------------
...
;
ALTER TABLE "public"."asf_message_inbox" OWNER TO "kong";
...
-- ----------------------------
-- Records of asf_message_inbox
-- ----------------------------
BEGIN;
INSERT INTO "public"."asf_message_inbox" ("id", "create_time", "content", "title", "is_have_read", "read_time", "user_id", "img", "type") VALUES (1, '2024-12-02 06:57:07.105038', 'https://baidu.com', '测试11', 0, NULL, NULL, NULL, 0);
COMMIT;
...
OWNED BY "public"."asf_account_post"."id";
SELECT setval('"public"."asf_account_post_id_seq1"', 4, true);
...
OWNED BY "public"."asf_account_role"."id";
SELECT setval('"public"."asf_account_role_id_seq1"', 1, false);
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."asf_help_id_seq"
OWNED BY "public"."asf_help"."id";
SELECT setval('"public"."asf_help_id_seq"', 1, false);
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."asf_message_inbox_id_seq"
OWNED BY "public"."asf_message_inbox"."id";
SELECT setval('"public"."asf_message_inbox_id_seq"', 1, false);
...
OWNED BY "public"."asf_security_token"."id";
SELECT setval('"public"."asf_security_token_id_seq1"', 317, true);
...
-- ----------------------------
-- Auto increment value for asf_help
-- ----------------------------
SELECT setval('"public"."asf_help_id_seq"', 1, false);

-- ----------------------------
-- Indexes structure for table asf_help
-- ----------------------------
CREATE INDEX "IX_help_category" ON "public"."asf_help" USING btree (
  "category" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."IX_help_category" IS '分类索引';
CREATE INDEX "IX_help_title" ON "public"."asf_help" USING btree (
  "title" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table asf_help
-- ----------------------------
ALTER TABLE "public"."asf_help" ADD CONSTRAINT "asf_help_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Auto increment value for asf_message_inbox
-- ----------------------------
SELECT setval('"public"."asf_message_inbox_id_seq"', 1, false);

-- ----------------------------
-- Indexes structure for table asf_message_inbox
-- ----------------------------
CREATE INDEX "IX_message_title" ON "public"."asf_message_inbox" USING btree (
  "title" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
COMMENT ON INDEX "public"."IX_message_title" IS '站内信标题';

-- ----------------------------
-- Primary Key structure for table asf_message_inbox
-- ----------------------------
ALTER TABLE "public"."asf_message_inbox" ADD CONSTRAINT "asf_message_inbox_pkey" PRIMARY KEY ("id");
