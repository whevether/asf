...
namespace ASF.Internal.Utils
{
    ...
    public interface IHttpHelper
    {
        ...
        /// post泛型请求
        /// </summary>
        Task<T> PostResponse<T>(string url, Dictionary<string, string> dic,Dictionary<string,string> header = null) where T : class, new();
        /// <summary>
        /// post泛型请求 传入json对象
        /// </summary>
        Task<T> PostResponse<T>(string url, object content,Dictionary<string,string> header = null) where T : class, new();
        /// <summary>
        /// post泛型请求 传入json对象
        /// </summary>
