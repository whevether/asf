...
namespace ASF.Domain.Services
{
	...
	public class TranslateService
	{
		...
		{
			if (await _translateRepositories.GetEntity(f => f.TenancyId == translate.TenancyId && f.Value.Equals(translate.Value)) != null)
		...
		{
			if (await _translateRepositories.GetEntity(f =>f.Id !=translate.Id && f.TenancyId == translate.TenancyId &&f.Value.Equals(translate.Value)) != null)
				return Result.ReFailure(ResultCodes.TranslateNameExist);
