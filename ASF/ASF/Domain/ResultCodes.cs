...
namespace ASF.Domain
{
    ...
    public class ResultCodes : BaseResultCodes
    {
        ...
        public static ValueTuple<int, string> AccountOldTelPhoneError = (11013, "与旧手机号码相同，无需修改");
        ...
        public static ValueTuple<int, string> RoleDeleteError = (12008, "删除角色失败");
        //权限错误码
        ...
        public static ValueTuple<int, string> PermissionSystemNotCreate = (13005, "只有超级管理员才能创建系统权限");
