...
namespace ASF.Application
{
	...
	public class MenuController: ControllerBase
	{
		...
		public async Task<Result> Create([FromBody] PermissionMenuCreateRequestDto dto)
		{
			...
			PermissionMenu permissionMenu = _mapper.Map<PermissionMenu>(dto);
			permissionMenu.TenancyId = tenancyId;
			if(permissionMenu.IsSystem != null &&(Status)permissionMenu.IsSystem == Status.Yes && !HttpContext.User.IsSuperRole())
